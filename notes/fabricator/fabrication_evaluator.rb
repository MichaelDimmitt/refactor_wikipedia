...
# https://github.com/paulelliott/fabrication/blob/master/lib/fabrication/schematic/evaluator.rb

# my goal in posting this note is to research for my feature
# autorun is_nil check on every assignment.
